...
fn main() {
    ...
    let component_names = [
        "simple_paxos_wasm_proposer",
        "simple_paxos_wasm_acceptor",
        "simple_paxos_wasm_learner",
    ];

    let component_module_names = [
        "simple_paxos_proposer.wasm",
        "simple_paxos_acceptor.wasm",
        "simple_paxos_learner.wasm",
    ];
