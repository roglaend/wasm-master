...
wasmtime::component::bindgen!({
    ...
    path: "proposer/wit/proposer.wit",
});
...
impl PaxosWasmRuntime {
    pub fn new(engine: &Engine) -> Result<Self> {
        ...
        let target_dir = workspace_dir.join(PathBuf::from("target/wasm32-wasip2/release"));
        let proposer_path = target_dir.join("simple_paxos_proposer.wasm");

        println!("{:?} {}", {}, proposer_path.display());
