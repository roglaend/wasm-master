    ...
    pub mod subtracter {
        ...
        pub mod sub {
            ...
            pub fn sub(a: u32, b: u32) -> u32 {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "docs:subtracter/sub@0.1.0")]
                    extern "C" {
                        #[link_name = "sub"]
                        fn wit_import(_: i32, _: i32) -> i32;
                    }
...
d@0.1.0\x05\0\x01B\x02\x01@\x02\x01ay\x01by\0y\x04\0\x03sub\x01\0\x03\0\x19docs:\
subtracter/sub@0.1.0\x05\x01\x01B\x04\x01m\x02\x03add\x03sub\x04\0\x02op\x03\0\0\
\x01@\x03\x02op\x01\x01xy\x01yy\0y\x04\0\x0feval-expression\x01\x02\x04\0\x1fdoc\
s:calculator/calculate@0.1.0\x05\x02\x04\0\x20docs:calculator/calculator@0.1.0\x04\
