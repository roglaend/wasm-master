    ...
    pub mod paxos {
        pub mod proposer {
            ...
            pub mod types {
                ...
                #[doc(hidden)]
                macro_rules! __export_paxos_proposer_types_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = {};
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_paxos_proposer_types_0_1_0_cabi;
            }
            ...
            pub mod proposerinterface {
                ...
                static __FORCE_SECTION_REF: fn() = super::super::super::super::__link_custom_section_describing_imports;
                use super::super::super::super::_rt;
                pub type Promise = super::super::super::super::exports::paxos::proposer::types::Promise;
                pub type Accept = super::super::super::super::exports::paxos::proposer::types::Accept;
                pub type Prepare = super::super::super::super::exports::paxos::proposer::types::Prepare;
                #[derive(Debug)]
                #[repr(transparent)]
                ...
                >(arg0: *mut u8, arg1: i32) -> *mut u8 {
                    ...
                    let super::super::super::super::exports::paxos::proposer::types::Prepare {
                        from: from2,
                        crnd: crnd2,
                    } = result0;
                ...
                >(
                    ...
                    let result1 = T::handlepromise(
                        ProposerresourceBorrow::lift(arg0 as u32 as usize).get(),
                        super::super::super::super::exports::paxos::proposer::types::Promise {
                            to: arg1 as u32,
                            from: arg2 as u32,
                            rnd: arg3 as u32,
                            vrnd: arg4 as u32,
                    ...
                    let super::super::super::super::exports::paxos::proposer::types::Accept {
                        from: from3,
                        rnd: rnd3,
                        val: val3,
                    } = result1;
                ...
                pub unsafe fn _export_handle_request_cabi<T: Guest>(
                    ...
                    let result1 = T::handle_request(
                        ProposerresourceBorrow::lift(arg0 as u32 as usize),
                ...
                macro_rules! __export_paxos_proposer_proposerinterface_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        unsafe extern "C" fn
                        export_method_proposerresource_makeprepare(arg0 : * mut u8, arg1
                        ...
                        $($path_to_types)*:: Guest >::Proposerresource > (arg0) }
                        #[export_name =
                        "paxos:proposer/proposerinterface@0.1.0#handle-request"] unsafe
                        ...
                        #[export_name =
                        "cabi_post_paxos:proposer/proposerinterface@0.1.0#handle-request"]
...
macro_rules! __export_proposerworld_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::paxos::proposer::types::__export_paxos_proposer_types_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::paxos::proposer::types);
        $($path_to_types_root)*::
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 840] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xc4\x05\x01A\x02\x01\
A\x07\x01B\x08\x01r\x03\x02idy\x04crndy\x08nummodesy\x04\0\x08proposer\x03\0\0\x01\
...
\0\x07prepare\x03\0\x06\x04\0\x1apaxos:proposer/types@0.1.0\x05\0\x02\x03\0\0\x07\
promise\x02\x03\0\0\x06accept\x02\x03\0\0\x07prepare\x01B\x16\x02\x03\x02\x01\x01\
\x04\0\x07promise\x03\0\0\x02\x03\x02\x01\x02\x04\0\x06accept\x03\0\x02\x02\x03\x02\
\x01\x03\x04\0\x07prepare\x03\0\x04\x04\0\x10proposerresource\x03\x01\x01i\x06\x01\
@\x02\x02idy\x08nummodesy\0\x07\x04\0\x1d[constructor]proposerresource\x01\x08\x01\
h\x06\x01@\x02\x04self\x09\x05valuey\0\x05\x04\0$[method]proposerresource.makepr\
epare\x01\x0a\x01@\x02\x04self\x09\x07promise\x01\0\x03\x04\0&[method]proposerre\
source.handlepromise\x01\x0b\x01@\x02\x04self\x09\x05valuey\x01\0\x04\0%[method]\
proposerresource.requestvalue\x01\x0c\x01@\x01\x04self\x09\x01\0\x04\0%[method]p\
roposerresource.increasecrnd\x01\x0d\x01o\x02ss\x01@\x02\x01v\x09\x07requests\0\x0e\
\x04\0\x0ehandle-request\x01\x0f\x04\0&paxos:proposer/proposerinterface@0.1.0\x05\
\x04\x04\0\"paxos:proposer/proposerworld@0.1.0\x04\0\x0b\x13\x01\0\x0dproposerwo\
