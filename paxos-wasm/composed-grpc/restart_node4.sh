...
CMD="wt.exe new-tab --title \"Node 4\" bash -c \"NUM_NODES=${NUM_NODES} BASE_PORT=${BASE_PORT} BASE_IP=${BASE_IP} LEADER_ID=${LEADER_ID} RUST_LOG=${LOG_LEVEL} ./target/debug/composed-grpc --node-id 4\""
