...
impl HostMessenger {
    ...
    pub async fn send_message(
        ...
        // Process and filter out invalid responses. // TODO: Do we want to filter the failed responses out?
        responses_result
            ...
            .flat_map(|responses| {
                responses.into_iter().filter_map(|res| match res {
                    Ok(r) => {
                        ...
                        match paxos_bindings::paxos::default::network::NetworkResponse::try_from(
                            proto_resp,
                        ) {
