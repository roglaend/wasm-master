use crate::{exports::paxos::default::{coordinator_types, network_types, paxos_types}, paxos::network_types::MessagePayload};
...
pub fn convert_internal_state_to_proto(
    internal_state: coordinator_types::PaxosState,
...
) -> coordinator_types::PaxosState {
    let learned = proto_state
        .learned
        .into_iter()
        .map(|entry| coordinator_types::LearnedEntry {
            slot: entry.slot,
